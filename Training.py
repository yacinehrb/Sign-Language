...
training_set = train_datagen.flow_from_directory(r'C:\PROJECTS\AI\SIGN LANGUAGE TRANSLATOR\data\train',
                                                 target_size=(64,64),
                                                 batch_size=5,  
...
testing_set=test_datagen.flow_from_directory(r'C:\PROJECTS\AI\SIGN LANGUAGE TRANSLATOR\data\test',
						 target_size=(64,64),
                                                 batch_size=5,  
                                                 color_mode='grayscale',
                                                 class_mode='categorical')
